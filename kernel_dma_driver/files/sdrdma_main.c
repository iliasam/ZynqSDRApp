// This is is kernel module for OpenZynqSDR - "sdrdma".
// It is used by SDR App in "/zynq/peri.cpp"
//
...
MODULE_AUTHOR
    ("iliasam");
MODULE_DESCRIPTION
    ("sdrdma - loadable module generated by petalinux-create -t modules");
...
// Workqueue Function
// Scheduled in sdrdma_sound_irq_handler()
