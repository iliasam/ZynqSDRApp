			...
			w3_half('', '',
				...
				w3_div('w3-margin-L-8',
					...
					w3_inline('w3-tspace-8/w3-margin-between-6',
					   w3_select('w3-text-red', 'Draw', '', 'iq.draw', iq.draw, draw_s, 'iq_display_draw_select_cb'),
					   w3_select('w3-text-red', 'Mode', '', 'iq.mode', iq.mode, mode_s, 'iq_display_mode_select_cb'),
					   w3_select('w3-text-red', 'PLL', '', 'iq.pll', iq.pll, pll_s, 'iq_display_pll_select_cb')
					),
